...
SET mazData_File='C:\Working\popsyn3\pop10_tm2\data\2010\mazData.csv'
SET tazData_File='C:\Working\popsyn3\pop10_tm2\data\2010\tazData.csv'
SET countyData_File='C:\Working\popsyn3\pop10_tm2\data\2010\countyData.csv'
SET personsByAge_File='C:\Working\popsyn3\pop10_tm2\data\2010\personsByAge.csv'
