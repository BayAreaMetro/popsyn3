...
#### TODO
2. write to disk
3. refactor STEP 03 to accommodate changes
4. add new controls and batch runs
5. try to do TAZ with blockgroup to TAZ correspondence
...
raw_census <- getCensus(name = "sf1", 
                        vintage = 2010, 
                        key = api_key$key, 
                        vars=c("P012I003", "P012I004", "P012I005", "P012I006", "P012I007", "P012I008", "P012I009", "P012I010",
                               "P012I011", "P012I012", "P012I013", "P012I014", "P012I015", "P012I016", "P012I017", "P012I018",
                               "P012I019", "P012I020", "P012I021", "P012I022", "P012I023", "P012I024", "P012I025",
                               "P012I027", "P012I028", "P012I029", "P012I030", "P012I031", "P012I032", "P012I033", "P012I034", 
                               "P012I035", "P012I036", "P012I037", "P012I038", "P012I039", "P012I040", "P012I041", "P012I042", 
                               "P012I043", "P012I044", "P012I045", "P012I046", "P012I047", "P012I048", "P012I049"), 
                        region = paste("county:", COUNTY_FIPS_STRING, sep = ""),
                        regionin = paste("state:", STATE_FIPS, sep = ""))
...
working <- working %>%
  mutate(age_00_05 = P012I003 + P012I027) %>%
  mutate(age_05_09 = P012I004 + P012I028) %>%
  mutate(age_10_14 = P012I005 + P012I029) %>%
  mutate(age_15_17 = P012I006 + P012I030) %>%
  mutate(age_18_19 = P012I007 + P012I031) %>%
  mutate(age_20_20 = P012I008 + P012I032) %>%
  mutate(age_21_21 = P012I009 + P012I033) %>%
  mutate(age_22_24 = P012I010 + P012I034) %>%
  mutate(age_25_29 = P012I011 + P012I035) %>%
  mutate(age_30_34 = P012I012 + P012I036) %>%
  mutate(age_35_39 = P012I013 + P012I037) %>%
  mutate(age_40_44 = P012I014 + P012I038) %>%
  mutate(age_45_49 = P012I015 + P012I039) %>%
  mutate(age_50_54 = P012I016 + P012I040) %>%
  mutate(age_55_59 = P012I017 + P012I041) %>%
  mutate(age_60_61 = P012I018 + P012I042) %>%
  mutate(age_62_64 = P012I019 + P012I043) %>%
  mutate(age_65_66 = P012I020 + P012I044) %>%
  mutate(age_67_69 = P012I021 + P012I045) %>%
  mutate(age_70_74 = P012I022 + P012I046) %>%
  mutate(age_75_79 = P012I023 + P012I047) %>%
  mutate(age_80_84 = P012I024 + P012I048) %>%
  mutate(age_85_up = P012I025 + P012I049) %>%
  mutate(age_00_18 = age_00_05 + age_05_09 + age_10_14 + age_15_17 + round(0.5 * age_18_19)) %>%
  mutate(age_19_64 = round(0.5 * age_18_19) + age_20_20 + age_21_21 + age_22_24 + age_25_29 + age_30_34 + age_35_39 + age_40_44 + age_45_49 +
           age_50_54 + age_55_59 + age_60_61 + age_62_64) %>%
  mutate(age_65_up = age_65_66 + age_67_69 + age_70_74 + age_75_79 + age_80_84 + age_85_up) %>%
