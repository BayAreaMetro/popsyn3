...
So CT-RAMP may use some of these and the population synthesizer may use others. In either case, track down equivalents (if possible) in the 2000 PUMS if I decide to try and use the 2000 PUMS as the seed. 

2. hweight has missing values -- why?
