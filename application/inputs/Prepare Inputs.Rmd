...
dbWriteTable(conn = mysql_connection, name = 'household_table',   value = as.data.frame(pums_hh),  overwrite = TRUE)
dbWriteTable(conn = mysql_connection, name = 'person_table', value = as.data.frame(pums_per), overwrite = TRUE)
